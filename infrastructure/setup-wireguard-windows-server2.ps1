# =============================================================================
# WireGuard Setup Script for Windows Server 2019 - Server 2 (91.99.23.239)
# =============================================================================
...
Write-Host "  WireGuard Setup - Server 2" -ForegroundColor Cyan
...
Write-Host "  infrastructure/setup-wireguard-wsl2-server2.sh" -ForegroundColor White
Write-Host ""
