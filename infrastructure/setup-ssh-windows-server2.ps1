# =============================================================================
# SSH Setup Script for Windows Server 2019 - Server 2 (91.99.23.239)
# =============================================================================
...
Write-Host "   ssh -i /opt/nexusvpn/.ssh/id_rsa Administrator@91.99.23.239 'echo Test'" -ForegroundColor Cyan
Write-Host ""
